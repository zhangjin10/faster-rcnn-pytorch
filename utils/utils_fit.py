...
def fit_one_epoch(model, train_util, loss_history, eval_callback, optimizer,
    ...
    with tqdm(
        ...
        for iteration, batch in enumerate(gen):
            ...
            rpn_loc, rpn_cls, roi_loc, roi_cls, total = train_util.train_step(
                images, boxes, labels, 1, fp16, scaler)
    ...
    with tqdm(
        ...
        for iteration, batch in enumerate(gen_val):
            ...
            with torch.no_grad():
                ...
                _, _, _, _, val_total = train_util.forward(
                    images, boxes, labels, 1)
